...
/*3L*****************/
        ...
        arNrnCnct[1][0]=-1;
        arNrnCnct[2][0]=-1;
        nrNet[3][0]=new Neuron(11,iModel, iActivFunc, arNrnCnct,(short)1,"Выключатель зажигания");
        /*Перегорел предохранитель*/
        arNrnCnct=new int[3][1];
        arNrnCnct[0][0]=-1;
        arNrnCnct[1][0]=-1;
        arNrnCnct[2][0]=-1;
        nrNet[3][1]=new Neuron(11,iModel, iActivFunc, arNrnCnct,(short)1,"Перегорел предохранитель");
        /*Не соответствие режима стеклоочистителя*/
        arNrnCnct=new int[3][1];
        arNrnCnct[0][0]=-1;
        arNrnCnct[1][0]=-1;
        arNrnCnct[2][0]=-1;
        nrNet[3][2]=new Neuron(11,iModel, iActivFunc, arNrnCnct,(short)1,"Не соответствие режима стеклоочистителя");
        /*Отсутствие импульсов с блока управления в режиме прерывисто*/
        arNrnCnct=new int[3][1];
        arNrnCnct[0][0]=-1;
        arNrnCnct[1][0]=-1;
        arNrnCnct[2][0]=-1;
        nrNet[3][3]=new Neuron(11,iModel, iActivFunc, arNrnCnct,(short)1,"Отсутствие импульсов с блока управления в режиме прерывисто");
        /*Отсутствие переключений реле в режиме прерывисто*/
        arNrnCnct=new int[3][1];
        arNrnCnct[0][0]=-1;
        arNrnCnct[1][0]=-1;
        arNrnCnct[2][0]=-1;
        nrNet[3][4]=new Neuron(11,iModel, iActivFunc, arNrnCnct,(short)1,"Отсутствие переключений реле в режиме прерывисто");
        /*Не включение концевых выключателей*/
        arNrnCnct=new int[3][1];
        arNrnCnct[0][0]=-1;
        arNrnCnct[1][0]=-1;
        arNrnCnct[2][0]=-1;
        nrNet[3][5]=new Neuron(11,iModel, iActivFunc, arNrnCnct,(short)1,"Не включение концевых выключателей");
        /*Не соответствие работы мотора заданному режиму*/
        arNrnCnct=new int[3][1];
        arNrnCnct[0][0]=-1;
        arNrnCnct[1][0]=-1;
        arNrnCnct[2][0]=-1;
        nrNet[3][6]=new Neuron(11,iModel, iActivFunc, arNrnCnct,(short)1,"Не соответствие работы мотора заданному режиму");
        break;
/*****************************************************************************/
